  ...
  return(
    <main className="yt-playlist">
      <div className="yt-playlist__video__play">
        <iframe title="list" width="100%" height="400" src={`https://www.youtube.com/embed/${video.snippet.resourceId.videoId}`} frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
